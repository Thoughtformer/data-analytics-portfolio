...
Does available public evidence support investment in an integrated community technology initiative that combines:
...
The evidence reviewed in this capstone supports the feasibility of such a model, while also identifying important limits on what can be claimed.
...
Household laptop use increased from:

- 41.2% for households under $25,000
- to 84.6% for households at $150,000 or more

Home-internet use increased from:

- 71.0%
- to 90.3%

This indicates that access to computing technology remains strongly associated with household income.

### Education

Among adults age 25 and older, laptop use increased from:

- 21.4% among adults with less than a high-school education
- to 77.3% among adults with graduate or professional education

Digital engagement showed similar differences.

### Older Adults

Among lower-income adults, age differences were especially visible.

For households under $25,000:

Adults ages 18–64:

- laptop use: 40.7%
- smartphone use: 77.6%
- home internet use: 74.3%

Adults age 65 and older:

- laptop use: 24.3%
- smartphone use: 58.3%
- home internet use: 55.9%

Older adults also showed lower use of online financial, government, and education/job-training services.

### Youth

Among youth ages 3–17, technology use also varied by family income.

Laptop use increased from:

- 29.3% among youth in households under $25,000
- to 47.7% among youth in households at $150,000 or more

### Interpretation

The NTIA results support the existence of measurable access and engagement gaps.

They do not establish that lack of hardware is the only cause of those gaps.
...
Open Repair Alliance data provides evidence that many technology devices brought to community repair events retain repair potential.

Among 23,612 core digital-access devices consisting of:
...
A combined 79.2% were either fixed or assessed as repairable.

### Interpretation

This supports the feasibility of recovering useful technology through repair and refurbishment.

It does not mean that 79.2% of all discarded devices are recoverable.

Devices appearing at community repair events are a self-selected population.

---

## 3. Repair Barriers

Among core access devices classified as end of life, the most common documented barriers were:

- spare parts too expensive: 24.4%
- repair information unavailable: 19.8%
- spare parts unavailable: 16.1%
- lack of equipment: 14.7%
- no way to open product: 13.1%
- item too worn out: 11.9%

A combined 88.1% of documented barriers involved something other than the device simply being too worn out.

However, barriers were documented for only 29.0% of core-device end-of-life records.

### Interpretation

Some repair failures may be associated with constraints that a structured refurbishment program could potentially address, including:
...
## 5. Personalized Digital Support

The Tech Allies program evaluated a model combining:

- tablet access
- broadband access
- repeated one-on-one instruction
- volunteer support

The intervention produced a statistically significant increase in technology use among participating older adults.

Technology confidence and social support showed weaker improvements.

Loneliness did not significantly improve.

### Interpretation

The evidence supports combining device access with personalized support rather than assuming that hardware distribution alone will resolve digital-use barriers.
...
Two comparable programs provide evidence that multiple components of the proposed model can operate together.
...
The 2016 pilot reported:

- 2,600 computers refurbished
...
```text
DIGITAL ACCESS AND ENGAGEMENT GAPS
                ↓
MANY DEVICES RETAIN REPAIR POTENTIAL
                ↓
REFURBISHMENT CAN PROVIDE HANDS-ON TRAINING
                ↓
REFURBISHED DEVICES CAN SUPPORT ACCESS PROGRAMS
                ↓
PERSONALIZED SUPPORT CAN IMPROVE TECHNOLOGY USE
                ↓
